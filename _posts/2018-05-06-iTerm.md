...
3. 安装powerline字体，为后面的ZSH主题作准备
   ...
   ![修改iTerm字体](/assets/img/20180506itermpreferences.png)
...
7. 安装语法高亮插件 [zsh-syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting)
...
8. 安装自动提示插件 [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions)
