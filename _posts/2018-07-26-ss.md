...
记录下关于shadowsocks的一些使用，以及手机电脑使用代理的过程。技术交流，不作恶😊。

<!--more-->

## 自建shadowsocks

> 自己搭建ss的过程可能会稍微复杂一些，成本也会略高一些。好处是基本没有流量的限制，也不用担心商家随时跑路的问题。
...
* [Surge](https://nssurge.com/)， 规则可以使用[lhie1](https://github.com/lhie1/Rules)，贵
* [ClashX](https://github.com/yichengchen/clashX/releases)，免费，功能不如surge完善，足够使用了，推荐。

* 当然也可以使用ssr客户端 [**ShadowsocksX-NG-R8.dmg**](https://github.com/qinyuhang/ShadowsocksX-NG-R/releases/download/1.4.3-R8-build3/ShadowsocksX-NG-R8.dmg)  免费

这里推荐[Surge为Parallels虚拟机代理上网](https://juejin.im/post/5ae921bf6fb9a07aad17528c)

#### Windows

* [clash_for_windows_pkg](https://github.com/Fndroid/clash_for_windows_pkg/releases)  Clash的Windows图形界面；[这里有介绍](https://docs.cfw.lbyczf.com/)
